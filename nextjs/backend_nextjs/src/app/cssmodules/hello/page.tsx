...
>
  ...
  <span className="absolute bottom-0 left-0 h-full -ml-2">
    <svg
      ...
      className="w-auto h-fillOpacity-100 object-stretch"
      viewBox="0 0 487 487"
    >
      <path
        fillOpacity=".1"
  ...
  <span
    className="absolute inset-0 w-full h-full -mt-1 roundefillOpacity-30 bg-gradient-to-b from-transparent via-transparent to-gray-200"
  ></span>
