  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-blue-50 via-indigo-100 to-purple-200 p-10'>
      <div className='max-w-7xl mx-auto bg-white rounded-lg shadow-2xl p-8'>
        ...
        <p className='text-lg text-gray-700 mb-8 max-w-2xl'>Customize your accout settings, profile, and notifications here. Choose an option from the sidebar to begin</p>
      ...
      <div className='flex space-x-12'>
        ...
        <div className='flex-1 bg-white shadow-md rounded-lg p-8'>
          ...
          <p className='text-lg text-gray-600 max-w-3xl'>
            Choose an option from the sidebar to mange your accout, notifications, or profile settings
          </p>
        </div>
      </div>
      </div>
